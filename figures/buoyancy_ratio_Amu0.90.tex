...
\addplot [color=black, line width=1.4pt, mark=o, mark options={solid, black}]
  table[row sep=crcr]{%
0.05	0.999979453601811\\
0.25	0.997019470046642\\
0.5	0.984253560617495\\
0.8	1.01499404907749\\
};
\addlegendentry{$\mathrm{Sc}=0.5$}

\addplot [color=white!35!black, line width=1.4pt, mark=o, mark options={solid, white!35!black}]
  table[row sep=crcr]{%
0.05	0.9999948478194\\
0.25	0.999131627765867\\
0.5	0.992800890180936\\
0.8	0.974519702968429\\
};
\addlegendentry{$\mathrm{Sc}=1$}

\addplot [color=white!60!black, line width=1.4pt, mark=o, mark options={solid, white!60!black}]
  table[row sep=crcr]{%
0.05	0.999999835135357\\
0.25	0.999968219279401\\
0.5	0.999626707534748\\
0.8	0.997359261385053\\
};
\addlegendentry{$\mathrm{Sc}=5$}

\addplot [color=mycolor1, line width=1.4pt, mark=o, mark options={solid, mycolor1}]
  table[row sep=crcr]{%
0.05	0.999999965990712\\
0.25	0.99999435035388\\
0.5	0.999914855825306\\
0.8	0.999298364576536\\
};
