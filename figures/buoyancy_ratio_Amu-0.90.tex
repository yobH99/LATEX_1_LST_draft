...
ylabel={$\mathcal{P}_b/\mathcal{P}_{b,0}$},
...
\addplot [color=black, line width=1.4pt, mark=o, mark options={solid, black}]
  table[row sep=crcr]{%
0.05	0.999970312962696\\
0.25	0.996704356348093\\
0.5	0.984314145613397\\
0.8	1.04170047116469\\
};
\addlegendentry{$\mathrm{Sc}=0.5$}

\addplot [color=white!35!black, line width=1.4pt, mark=o, mark options={solid, white!35!black}]
  table[row sep=crcr]{%
0.05	0.999992772838484\\
0.25	0.99899403829817\\
0.5	0.992855324605218\\
0.8	0.985026665329476\\
};
\addlegendentry{$\mathrm{Sc}=1$}

\addplot [color=white!60!black, line width=1.4pt, mark=o, mark options={solid, white!60!black}]
  table[row sep=crcr]{%
0.05	0.999999615648951\\
0.25	0.999938347504437\\
0.5	0.999440071155934\\
0.8	0.99611937184794\\
};
\addlegendentry{$\mathrm{Sc}=5$}

\addplot [color=mycolor1, line width=1.4pt, mark=o, mark options={solid, mycolor1}]
  table[row sep=crcr]{%
0.05	0.999999888468264\\
0.25	0.99997893460426\\
0.5	0.999810995501944\\
0.8	0.998218197947887\\
};
